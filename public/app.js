...
async function loadScores() {
  ...
  try {
    ...
    /*
      YepFootball only displays its supported competitions.
      This prevents unrelated leagues from appearing in "All".
    */
    ...
    */
    ...
    /*
      Retry once after a short delay without
      creating additional API traffic loops.
    */
    window.setTimeout(
      () => loadScores(),
      20000
